...
[Antigravity](https://antigravity.google/) 是一款由 Google 公司推出的 AI 编辑器。它的 Agent Manager 非常好用，与传统代码编辑区位于不同窗口，能让你在独立的窗口中管理你与 AI 的会话。

留白记事现已完成 Antigravity 上的适配：

让你与 Gemini 3 工作时，也能轻松捕捉灵光乍现💡的每一份想法，或者快速新建待办或日程！

## 安装 {#install}

### 1. 搜索

你可以尝试 [点击这个链接](antigravity:extension/ptsd.liubai-vscode-extension)，直接在 Antigravity 中安装。

如果上述链接无法打开，你可以手动切换至 Antigravity 中的 `Extensions: Marketplace`：
...
![返回 Antigravity](./assets-vscode/6.png)
